...
<head>
  ...
  <link rel="stylesheet" href="css/inspektr.css" type="text/css" media="screen" />
...
<div id="header">
  <div id="nav-system">
    <ul
      ><li><a href="logout.html" title="logout of current session">logout</a></li
    ></ul>
  </div>
  <p id="tagline">Rutgers University</p>
  <h1 id="app-name">Inspektr Logs &amp; Statistics Viewer</h1>
</div>
<div id="nav-main">
  <ul
    ><li><a id="addServiceView" href="add.html"><span>logs</span></a></li
    ><li><a id="manageServiceView" href="manage.html"><span>statistics</span></a></li
  ></ul>
</div>
<!-- CONTENT -->
<div id="content">
  <h1><spring:message code="${pageTitle}" text="Page Title" /></h1>
